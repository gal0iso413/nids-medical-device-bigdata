# Class 2 local integrated host

This localhost-only host serves a verified Class 2 React production build and
...
python -m services.class2_local_api `
  ...
  --static-root "D:\NIDS Local Run\class2-web-dist" `
  --host 127.0.0.1 `
  --port 8012
```

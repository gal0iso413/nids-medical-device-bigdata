...
The only input is the PR-28 Class 2 serving-mart directory. The service never
...
`requirements-class2-api.txt` pins DuckDB 1.5.5, FastAPI 0.141.1, and Uvicorn
...
offline-kit refresh. The next PR may add API mode to Class 2 React's existing

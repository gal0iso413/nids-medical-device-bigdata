...
Class 2 is a company/product-group comparison analysis. Its active route is
verified monthly Parquet, `data_pipeline.offline.class2_analysis_export`, and
the React interface in `web/class2_public/`. The browser consumes only the
...
The former Class 2 MCDM/Streamlit implementation and meeting prototypes were
...
`shared_docs/structured/onsite_visit1_summary.md` only as historical
production-calibration context.

## Guardrails

- No runtime may import the removed Class 2 implementation.

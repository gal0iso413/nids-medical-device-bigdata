...
export interface ApiComparisonView { period_start: string; period_end: string; selections: ApiSelection[]; product_catalog: Array<Record<string, unknown>>; product_month: Array<Record<string, unknown>>; item_group_month: Array<Record<string, unknown>>; endpoint_composition: Array<Record<string, unknown>>; coverage: Array<Record<string, unknown>>; }

const forbidden = ["src_company_id", "dst_company_id", "co:", "hosp:", "raw_score"];

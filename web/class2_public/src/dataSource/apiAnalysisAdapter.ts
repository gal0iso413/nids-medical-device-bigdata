...
function apiBaseUrl(): string { const base = import.meta.env.VITE_CLASS2_API_BASE_URL ?? "/api"; if (!base.startsWith("/") || base.startsWith("//")) throw new Error("API base URL must be same-origin."); return base.replace(/\/$/, ""); }

export const class2AnalysisSchemaVersion = "1.0.0" as const;

export type Class2SelectionType = "item_group" | "item_name";
export type NullableDecimal = string | null;
export type NullableString = string | null;
export type NullableCount = number | null;

export interface Class2SelectionCatalogRow {
  selection_id: string;
  selection_type: Class2SelectionType;
  label: string;
...
export interface Class2SelectionMonthMetricRow {
  selection_id: string;
  selection_type: Class2SelectionType;
  month: string;
...
export interface Class2SelectionMonthCompositionRow {
  selection_id: string;
  selection_type: Class2SelectionType;
  month: string;
...
export interface Class2SelectionCoverageSummaryRow {
  selection_id: string;
  selection_type: Class2SelectionType;
  period_start: string;
  period_end: string;
...
export interface Class2AnalysisPayload {
  analysis_schema_version: typeof class2AnalysisSchemaVersion;
  selection_catalog: Class2SelectionCatalogRow[];
  selection_month_metrics: Class2SelectionMonthMetricRow[];
  selection_month_composition: Class2SelectionMonthCompositionRow[];
  selection_coverage_summary: Class2SelectionCoverageSummaryRow[];
}

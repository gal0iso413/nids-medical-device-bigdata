...
import App from "../App";
import { loadLocalClass2Analysis } from "../dataSource/localAnalysisAdapter";

describe("canonical Class 2 local artifact handoff", () => {
  it("loads the tracked synthetic artifact through the local adapter and renders catalog coverage", async () => {
    ...
    const analysis = await loadLocalClass2Analysis("/canonical", async () => new Response(JSON.stringify(fixture.class2), { status: 200 }));

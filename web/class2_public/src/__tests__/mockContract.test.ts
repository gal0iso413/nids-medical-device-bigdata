...
import schema from "../mock/schema/class2-mock-view.schema.json";

const ajv = new Ajv({ allErrors: true, strict: true, strictRequired: false });
const validate = ajv.compile<Class2MockFixture>(schema);
...
describe("Class 2 development mock contract", () => {

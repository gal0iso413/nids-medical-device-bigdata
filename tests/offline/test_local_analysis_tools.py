...
from data_pipeline.offline.local_analysis_tools import inventory_monthly_fact, publish_class1_web_artifact, verify_class1_artifact, verify_class1_web_artifact, verify_class2_artifact
...
class LocalAnalysisToolsTests(unittest.TestCase):
    def test_inventory_and_verifiers_use_existing_artifacts(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            public = root / "public"
            export_class2_analysis(parquet_root=parquet, period_start="202401", period_end="202402", selections=(Class2SelectionRequest("item_group", "GROUP"),), web_public_root=public)
            self.assertTrue(verify_class2_artifact(web_public_root=public)["local_only"])
